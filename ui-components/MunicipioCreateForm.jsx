...
import { createMunicipio } from "./graphql/mutations";
const client = generateClient();
export default function MunicipioCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setNombreMunicipio(initialValues.nombreMunicipio);
    setErrors({});
  };
  const validations = {
    nombreMunicipio: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createMunicipio.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "MunicipioCreateForm")}
      {...rest}
    >
      <TextField
